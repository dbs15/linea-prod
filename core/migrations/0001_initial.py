# Generated by Django 4.2.16 on 2025-11-30 21:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kg_despues_trilla', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='KG después de trilla (Excelso)')),
                ('porcentaje_reduccion_excelso', models.DecimalField(blank=True, decimal_places=2, editable=False, max_digits=5, null=True, verbose_name='Reducción Excelso (%)')),
            ...
            options={
                ...
                'ordering': ['created_at'],
                'permissions': [('can_manage_orders', 'Puede gestionar maquilas'), ('can_view_all_orders', 'Puede ver todas las maquilas')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('process_status', models.CharField(choices=[('received', 'Recibido'), ('started', 'Iniciado'), ('monitoring', 'Monitoreando'), ('completed', 'Completado')], default='received', max_length=20, verbose_name='Estado del proceso')),
                ...
                ('toasting_equipment', models.CharField(choices=[('industrial_200kg', 'Industrial 200kg'), ('industrial_500kg', 'Industrial 500kg'), ('artisanal_50kg', 'Artesanal 50kg'), ('experimental_10kg', 'Experimental 10kg')], default='industrial_200kg', max_length=30, verbose_name='Equipo de tostión')),
                ('equipment_capacity_kg', models.PositiveIntegerField(default=200, verbose_name='Capacidad del equipo (kg)')),
                ...
                ('initial_temperature_celsius', models.DecimalField(decimal_places=1, default=150.0, max_digits=5, verbose_name='Temperatura inicial (°C)')),
                ('target_temperature_celsius', models.DecimalField(decimal_places=1, default=200.0, max_digits=5, verbose_name='Temperatura objetivo (°C)')),
                ('estimated_time_minutes', models.PositiveIntegerField(default=15, verbose_name='Tiempo estimado (min)')),
                ('current_temperature_celsius', models.DecimalField(blank=True, decimal_places=1, max_digits=5, null=True, verbose_name='Temperatura actual (°C)')),
                ('current_time_elapsed_minutes', models.PositiveIntegerField(default=0, verbose_name='Tiempo transcurrido (min)')),
                ('current_humidity_percentage', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Humedad actual (%)')),
                ('current_weight_loss_kg', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Pérdida de peso actual (kg)')),
                ('roast_type', models.CharField(choices=[('light', 'Claro'), ('medium', 'Medio'), ('dark', 'Oscuro')], max_length=20, verbose_name='Tipo de tueste')),
                ('quality_samples', models.JSONField(blank=True, default=dict, verbose_name='Muestras de calidad')),
                ('final_grain_quality', models.CharField(blank=True, choices=[('excellent', 'Excelente'), ('good', 'Buena'), ('regular', 'Regular'), ('poor', 'Deficiente')], max_length=20, null=True, verbose_name='Calidad final del grano')),
                ('final_quality_notes', models.TextField(blank=True, verbose_name='Notas finales de calidad')),
                ('notes', models.TextField(blank=True, verbose_name='Notas')),
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='toasting_process', to='core.order', verbose_name='Maquila')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, verbose_name='Notas')),
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='production_process', to='core.order', verbose_name='Maquila')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='invoice', to='core.order', verbose_name='Maquila')),
            ],
            options={
